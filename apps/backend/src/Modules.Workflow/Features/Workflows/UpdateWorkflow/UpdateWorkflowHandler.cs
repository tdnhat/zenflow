...
{
    public class UpdateWorkflowHandler : IRequestHandler<UpdateWorkflowCommand, WorkflowResponse?>
    {
        ...
        public async Task<WorkflowResponse?> Handle(UpdateWorkflowCommand request, CancellationToken cancellationToken)
        {
