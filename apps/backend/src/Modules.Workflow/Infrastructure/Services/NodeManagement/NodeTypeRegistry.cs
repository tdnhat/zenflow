using Modules.Workflow.Features;
using Modules.Workflow.Features.NodeTypes;

namespace Modules.Workflow.Infrastructure.Services.NodeManagement
{
    public interface INodeTypeRegistry
    {
        IEnumerable<GetNodeTypesResponse> GetAllNodeTypes();
        IEnumerable<string> GetCategories();
        IEnumerable<GetNodeTypesResponse> GetNodeTypesByCategory(string category);
        GetNodeTypesResponse? GetNodeTypeByType(string type);
    }

    public class NodeTypeRegistry : INodeTypeRegistry
    {
        private readonly Dictionary<string, GetNodeTypesResponse> _nodeTypes = new();
        ...
        {
            // TRIGGER NODES
            RegisterNodeType(new GetNodeTypesResponse(
                "manual-trigger",
                "Manual Trigger",
                "Triggers",
                "TRIGGER",
        ...
        public void RegisterNodeType(GetNodeTypesResponse nodeType)
        {
            _nodeTypes[nodeType.Type] = nodeType;
        }

        public IEnumerable<GetNodeTypesResponse> GetAllNodeTypes()
        {
        ...
        public IEnumerable<GetNodeTypesResponse> GetNodeTypesByCategory(string category)
        {
            return _nodeTypes.Values.Where(n => n.Category == category);
        }

        public GetNodeTypesResponse? GetNodeTypeByType(string type)
        {
