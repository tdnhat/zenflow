      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "fixed h-full w-full inset-0 bg-sidebar pt-16 px-6 z-[90] flex flex-col",
              className
            )}
          >
            <Button
...
export const SidebarLink = ({
  ...
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 hover:text-sidebar-primary transition-colors",
        className
      )}
      {...props}
    >
